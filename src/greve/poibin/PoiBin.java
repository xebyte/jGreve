//package greve.poibin;
//
///**
// * Created by xebyte on 30/03/15.
// */
//public class PoiBin {
//    private static int old_n = 0;
//
//    private static int nfac[];
//    private static int m_fac;
//    private static int kt;
//    private static int maxf;
//    private static int maxp;
//
//    public static double[] dftcf(double[] kk, double[] pp) {
//        int[] wts = new int[pp.length];
//        int n = 0;
...
//
//        int mm = kk.length;
//        double[] res = new double[kk.length];
//        int npp = pp.length;
...
//        int maxp = 0;
//
//        int[] fft = fft_factor(m, maxf, maxp);
//        maxf = fft[0];
//        maxp = fft[1];
//
...
//    }
//
//    private static boolean fft_work(double a, double b, int nseg, int n, int nspn, int isn,
...
//    }
//
//    private static int[] fft_factor(int n, int pmaxf, int pmaxp)
//    {
//        old_n = 0;
...
//        }
//
//        return new int[]{maxf, maxp};
//    }
//
//    private static int imax2(int x, int y) {
//        return (x < y) ? y : x;
//    }
//
